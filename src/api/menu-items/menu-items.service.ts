...
export class MenuItemsService {
  constructor(@InjectRepository(menu_items) private readonly menuRepo:Repository<menu_items>) { }
  ...
  async findAll() {
    try {
      const menu_items=await this.menuRepo.find({select:['id','name','description','price','is_available',],
